...
import dynsoft.xone.android.fragment.department.ThirdDepartmentAdapter;
...
public class ThirdDepartmentKanbanActivity extends FragmentActivity {
...
//    private ImageView imageViewRight;
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            thirdDepartmentAdapter.notifyDataSetChanged();
            handler.postDelayed(runnable, 10 * 60 * 1000);
        }
    };
    private ThirdDepartmentAdapter thirdDepartmentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kanban_thirddepartment);
        handler = new Handler();
...
//        imageViewRight.setImageBitmap(App.Current.ResourceManager.getImage("@/core_right_gray"));
    ...
    private void initViewPager() {
        thirdDepartmentAdapter = new ThirdDepartmentAdapter(getSupportFragmentManager());
        viewPager.setAdapter(thirdDepartmentAdapter);
