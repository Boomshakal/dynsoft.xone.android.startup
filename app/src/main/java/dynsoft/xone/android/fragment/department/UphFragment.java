...
import dynsoft.xone.android.wms.pn_sop_mgr;
...
public class UphFragment extends Fragment {
    ...
    private String curDate = "上次更新时间:" + new SimpleDateFormat("HH:mm:ss").format(new Date());               //显示当前日期
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        view = View.inflate(getActivity(), R.layout.fragment_uph_kanban, null);
        ...
        sharedPreferences = getActivity().getSharedPreferences("uph", Context.MODE_PRIVATE);
        ...
        textViewFresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Parameters p = new Parameters().add(1, "生产一部").add(2, "CP-PA");
                            ...
                            DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if (which >= 0) {
                                        ...
                                        UphFragment.this.segment = name.toString();
    ...
    private void initView() {
        ...
        if (imageViewFresh != null && isAdded()) {
    ...
    private void setPieChart(final int planQty, final int actualQty) {
        ...
        if (planQty <= 0 && actualQty <= 0) {
            ...
            if (actualQty < planQty && planQty != 0) {
                ...
                if (actual >= 0.8) {
                    parChartColors.add(Color.GREEN);
                } else if (actual >= 0.6) {
