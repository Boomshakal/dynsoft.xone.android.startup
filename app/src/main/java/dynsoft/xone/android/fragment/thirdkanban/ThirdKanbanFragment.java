package dynsoft.xone.android.fragment.thirdkanban;
...
import dynsoft.xone.android.activity.ThirdKanbanActivity;
...
public class ThirdKanbanFragment extends Fragment implements SpeechSynthesizerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = View.inflate(getActivity(), R.layout.activity_thirdkanban, null);
...
//                new AlertDialog.Builder(ThirdKanbanActivity.this)
//                        .setMessage("是否开启连班模式?")
...
//                                App.Current.toastInfo(ThirdKanbanActivity.this, "开启连班模式！");
//                            }
//                        }).show();
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            while (i < value.Value.Rows.size()) {
                                ...
                                mSpeechSynthesizer.setSpeechSynthesizerListener(ThirdKanbanFragment.this);
                                i++;
                            }
                        }
                    }.start();
...
//                listViewHolder.textView_4 = (TextView) (R.id.textview_4);
...
//                listViewHolder.textView_13 = (TextView) (R.id.textview_13);
...
//            listViewHolder.textView_4.setText(dataTables.get(i).getValue("item_code", ""));
            ...
            if (qty > 0) {
                String failPercent = String.valueOf((float) fail_count / (float) qty);   //百分比
                if (failPercent.length() > 5) {
                    listViewHolder.textView_11.setText(failPercent.substring(0, 5) + "%");
                } else {
