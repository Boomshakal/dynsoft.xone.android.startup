...
public class FaliaoStatusActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("item_name").length() > 22) {
            item_name = intent.getStringExtra("item_name").substring(0, 22);
        } else {
            item_name = intent.getStringExtra("item_name");
        }
        org_code = intent.getStringExtra("org_code");
        min_plan_date = intent.getStringExtra("min_plan_date");
...
//        ut = parameters.get("ut");
    ...
    public void Print2(final String BDAddress) {
        final EditText txt_split_qty = new EditText(FaliaoStatusActivity.this);
        new AlertDialog.Builder(FaliaoStatusActivity.this)
                .setTitle("请输入数量")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (number > 0) {
                            ...
                            App.Current.toastError(FaliaoStatusActivity.this, "输入有误！");
    ...
    public void Content() throws UnsupportedEncodingException {
        ...
        zkPrinter.drawText(320, 10, App.Current.UserCode + " - " + App.Current.UserName, 2, 0, false, false, false);
        zkPrinter.drawText(20, 55, org_code, 2, 0, false, false, false);
        zkPrinter.drawText(150, 55, cur_date, 2, 0, false, false, false);
        zkPrinter.drawText(20, 150, "机型编码：" + item_code, 2, 0, false, false, false);
        zkPrinter.drawText(20, 200, "机型名称：" + item_name, 2, 0, false, false, false);
        zkPrinter.DrawBarcodeQRcode(500, 150, code, 3, "128", 0);
        zkPrinter.drawText(50, 250, "套数：" + plan_quantity, 2, 0, false, false, false);
        zkPrinter.drawText(400, 250, min_plan_date, 2, 0, false, false, false);
        zkPrinter.drawText(40, 90, code, 6, 0, true, false, false);
