...
import dynsoft.xone.android.wms.pn_stock_item_lot_for_item;
...
//        ut = parameters.get("ut");
    ...
    public void Print2(final String BDAddress) {
        final EditText txt_split_qty = new EditText(Demo_ad_escActivity.this);
        new AlertDialog.Builder(Demo_ad_escActivity.this)
                .setTitle("请输入数量")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (number > 0) {
                            ...
                            App.Current.toastError(Demo_ad_escActivity.this, "输入有误！");
