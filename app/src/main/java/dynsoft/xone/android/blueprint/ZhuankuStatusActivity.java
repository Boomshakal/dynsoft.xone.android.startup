...
public class ZhuankuStatusActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        war_code = intent.getStringExtra("war_code");
        to_war_code = intent.getStringExtra("to_war_code");
...
//        ut = parameters.get("ut");
    ...
    public void Print2(final String BDAddress) {
        final EditText txt_split_qty = new EditText(ZhuankuStatusActivity.this);
        new AlertDialog.Builder(ZhuankuStatusActivity.this)
                .setTitle("请输入数量")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (number > 0) {
                            ...
                            App.Current.toastError(ZhuankuStatusActivity.this, "输入有误！");
    ...
    public void Content() throws UnsupportedEncodingException {
        ...
        zkPrinter.drawText(150, 240, "发出库位：" + war_code + "/" + "转入库位：" + to_war_code, 3, 0, false, false, false);
