...
public class ZaxiangStatusActivity extends Activity {
    /**
    ...
    private String min_plan_date;
    private String cur_date;
    private String plan_quantity;
    private List<Map<String, String>> list;
    private ListView listView;
    private String store_keeper_name;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        organization_code = intent.getStringExtra("organization_code");
        store_keeper_name = intent.getStringExtra("store_keeper_name");
...
//        ut = parameters.get("ut");
    ...
    public void Print2(final String BDAddress) {
        final EditText txt_split_qty = new EditText(ZaxiangStatusActivity.this);
        new AlertDialog.Builder(ZaxiangStatusActivity.this)
                .setTitle("请输入数量")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (number > 0) {
                            ...
                            App.Current.toastError(ZaxiangStatusActivity.this, "输入有误！");
    ...
    public void Content() throws UnsupportedEncodingException {
        ...
        if (cur_date.length() > 10) {
            zkPrinter.drawText(400, 10, cur_date.substring(0, 10), 2, 0, false, false, false);
            zkPrinter.drawText(400, 40, cur_date.substring(11), 2, 0, false, false, false);
        }
        zkPrinter.drawText(20, 60, "单号 ", 3, 0, false, false, false);
        zkPrinter.drawText(150, 60, code, 3, 0, false, false, false);
        zkPrinter.drawText(20, 120, "仓管员 ", 3, 0, false, false, false);
        zkPrinter.drawText(150, 120, store_keeper_name, 3, 0, false, false, false);
        zkPrinter.drawText(20, 180, "组织 ", 3, 0, false, false, false);
        zkPrinter.drawText(150, 180, organization_code, 3, 0, false, false, false);
        zkPrinter.drawText(20, 240, "备注 ", 3, 0, false, false, false);
        zkPrinter.drawText(150, 240, comment, 3, 0, false, false, false);
        zkPrinter.drawText(20, 5, type, 5, 0, false, false, false);

//        zkPrinter.drawText(20, 5, type, 5, 0, true, false, false);
//        zkPrinter.drawText(320, 10, cur_date.substring(0, 10) + "\n" + cur_date.substring(11), 2, 0, true, false, false);
//        zkPrinter.drawText(20, 60, "单号 " + code, 2, 0, true, false, false);
//        zkPrinter.drawText(20, 120, "仓管员 " + store_keeper_name, 2, 0, true, false, false);
//        zkPrinter.drawText(20, 180, "组织 " + organization_code, 2, 0, true, false, false);
//        zkPrinter.drawText(20, 240, "备注 " + comment, 2, 0, true, false, false);
...
//        zkPrinter.drawText(150, 260, App.Current.UserCode + "," + format, 2, 0, true, false, false);
