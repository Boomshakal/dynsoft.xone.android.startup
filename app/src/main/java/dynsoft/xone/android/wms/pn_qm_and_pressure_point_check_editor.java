...
public class pn_qm_and_pressure_point_check_editor extends pn_editor {
    private View view;
    ...
    public pn_qm_and_pressure_point_check_editor(Context context) {
        super(context);
    }
...
//    }
    ...
    private void loadComfirmName(final ButtonTextCell button_text_cell_4) {
        Link link = new Link("pane://x:code=pn_qm_and_pressure_point_check_record_parameter_mgr");
//        link.Parameters.add("textcell", textcell_1);
    ...
    private void loadWorkLineName(final ButtonTextCell text) {
        ...
        if (result.Value != null) {
            if (result.Value.Rows.size() == 1) {
                ...
                new AlertDialog.Builder(pn_qm_and_pressure_point_check_editor.this.getContext()).setTitle("请选择")
    ...
    private void loadItem(Integer id) {
        ...
        String sql = "exec get_qm_pressure_point_check_editor ?";
        ...
        App.Current.DbPortal.ExecuteRecordAsync("core_and", sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                pn_qm_and_pressure_point_check_editor.this.ProgressDialog.dismiss();
        ...
        if (TextUtils.isEmpty(button_text_cell_5.getContentText())) {
            ...
            App.Current.question(this.getContext(), "确定要提交吗？", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    dialog.dismiss();
                    String sql = "exec p_qm_and_pressure_point_check_create ?,?,?,?,?,?,?,?";
