...
public class pn_qm_and_ipqc_point_check_editor_screwdriver extends pn_editor {
    private View view;
    ...
    public pn_qm_and_ipqc_point_check_editor_screwdriver(Context context) {
        super(context);
    }
...
//                    timePickerView.setTime(format);
        ...
        if (text_cell_7 != null) {
            text_cell_7.setLabelText("电批扭力标准值");
        }
        if (text_cell_8 != null) {
            text_cell_8.setLabelText("电批扭力测试值");
        }
...
//        link.Parameters.add("textcell", textcell_1);
    ...
    private void loadWorkLineName(final ButtonTextCell text) {
        ...
        if (result.Value != null) {
            if (result.Value.Rows.size() == 1) {
                ...
                new AlertDialog.Builder(pn_qm_and_ipqc_point_check_editor_screwdriver.this.getContext()).setTitle("请选择")
    ...
    private void loadItem(Integer id) {
        ...
        String sql = "exec get_qm_ipqc_point_check_editor_screwdriver ?";
        ...
        App.Current.DbPortal.ExecuteRecordAsync("core_and", sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                pn_qm_and_ipqc_point_check_editor_screwdriver.this.ProgressDialog.dismiss();
        ...
        if (TextUtils.isEmpty(button_text_cell_5.getContentText())) {
            ...
            App.Current.question(this.getContext(), "确定要提交吗？", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    dialog.dismiss();
                    String sql = "exec p_qm_and_ipqc_point_check_create_screwdriver ?,?,?,?,?,?,?,?";
