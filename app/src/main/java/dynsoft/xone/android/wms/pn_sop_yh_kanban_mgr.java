...
public class pn_sop_yh_kanban_mgr extends pn_mgr {
    ...
    public pn_sop_yh_kanban_mgr(Context context) {
        super(context);
    }
        ...
        btn_commit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(textcell_2.getContentText())) {
                    ...
                    Intent intent = new Intent(getContext(), YhActivity.class);
    ...
    private void loadWorkLineName(final ButtonTextCell text) {
        String sql = "SELECT name   FROM dbo.fm_work_line  ORDER BY name";
    ...
    private void multiChoiceDialog(final StringBuffer nameMessage, final boolean[] selected, final ArrayList<String> names, final ButtonTextCell buttonTextCell) {
        new AlertDialog.Builder(pn_sop_yh_kanban_mgr.this.getContext()).setTitle("请选择")
