...
public class pn_qm_smt_on_part_report_mgr extends pn_mgr {
    private ButtonTextCell buttonTextCell;
    private ImageButton imageButtonCommit;
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor edit;

    public pn_qm_smt_on_part_report_mgr(Context context) {
        super(context);
    }
    ...
    public void onPrepared() {
        ...
        sharedPreferences = this.getContext().getSharedPreferences("smt", Context.MODE_PRIVATE);
...
//                generateValueFiles.generate();
                if (TextUtils.isEmpty(buttonTextCell.getContentText())) {
                    App.Current.toastError(pn_qm_smt_on_part_report_mgr.this.getContext(), "请先选择线体!");
                } else {
                    edit.putString("work_line", buttonTextCell.getContentText());
                    edit.commit();
                    Intent intent = new Intent(pn_qm_smt_on_part_report_mgr.this.getContext(), SMTOnPartActivity.class);
//                    Intent intent = new Intent(pn_qm_smt_on_part_report_mgr.this.getContext(), WIPActivity.class);
    ...
    private void chooseWorkLine() {
        String sql = "exec fm_get_smt_on_part_work_line";
        App.Current.DbPortal.ExecuteDataTableAsync("core_and", sql, new ResultHandler<DataTable>() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (value.HasError) {
                    App.Current.showError(pn_qm_smt_on_part_report_mgr.this.getContext(), value.Error);
                    return;
                }
...
//                    toastChooseDialog(value.Value);
                    ...
                    App.Current.toastError(pn_qm_smt_on_part_report_mgr.this.getContext(), "线体为空，请联系管理员！");
                }
            }
        });
    }
    ...
    private void toastChooseDialog(final DataTable value) {
        ...
        new AlertDialog.Builder(pn_qm_smt_on_part_report_mgr.this.getContext()).setTitle("请选择")
