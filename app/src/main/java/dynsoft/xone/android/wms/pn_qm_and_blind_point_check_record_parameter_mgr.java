...
public class pn_qm_and_blind_point_check_record_parameter_mgr extends pn_mgr {
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor edit;

    public pn_qm_and_blind_point_check_record_parameter_mgr(Context context) {
        super(context);
    }
...
//        txt_line5.setText(row.getValue("items", ""));
    ...
    public void openItem(DataRow row) {
        ...
        link.Parameters.add("item_code", row.getValue("item_code", 0));
