...
public class pn_qm_esd_daily_editor extends pn_editor {
    ...
    public void onPrepared() {
        ...
        if (text_cell_1 != null) {
            text_cell_1.setLabelText("线别");
            text_cell_1.setContentText(work_line);
        }

        if (text_cell_2 != null) {
            text_cell_2.setLabelText("项目");
        }

        if (text_cell_3 != null) {
            text_cell_3.setLabelText("内容");
        }
        ...
        App.Current.DbPortal.ExecuteRecordAsync("core_and", sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (value.Value != null) {
                    ...
                    if (all_data > 0) {
                        pn_qm_esd_daily_editor.this.Header.setTitleText("ESD稽查(" + String.valueOf(all_data) + "条检查任务)");
                    } else {
                        pn_qm_esd_daily_editor.this.Header.setTitleText("ESD稽查(无检检任务)");
                    }
                } else {
                    close();
                }
    ...
    private void chooseResult(final ButtonTextCell button_text_cell_4) {
        ...
        new AlertDialog.Builder(pn_qm_esd_daily_editor.this.getContext()).setTitle("请选择")
    ...
    public void prev() {
        if (line_id > 2) {
            ...
            App.Current.showError(pn_qm_esd_daily_editor.this.getContext(), "已经是第一条。");
        }
    }
    ...
    public void next() {
        if (line_id < counts) {
            ...
            App.Current.showError(pn_qm_esd_daily_editor.this.getContext(), "已经是最后一条。");
        }
    }
