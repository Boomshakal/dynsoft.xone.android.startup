...
public class pn_smt_steel_mesh_parameter_mgr extends pn_mgr {
	private SharedPreferences sharedPreferences;
	private SharedPreferences.Editor edit;
    public pn_smt_steel_mesh_parameter_mgr(Context context) {
        super(context);
    }
...
//        txt_line5.setText(row.getValue("items", ""));
    ...
    public void openItem(DataRow row) {
        super.openItem(row);
        Link link = new Link("pane://x:code=fm_smt_steel_mesh_tension_editor");
