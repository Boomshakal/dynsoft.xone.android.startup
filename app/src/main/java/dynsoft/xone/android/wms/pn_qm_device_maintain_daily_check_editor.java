...
public class pn_qm_device_maintain_daily_check_editor extends pn_editor {
    private View view;
    ...
    public pn_qm_device_maintain_daily_check_editor(Context context) {
        super(context);
    }
    ...
    public void setContentView() {
        ...
        view = App.Current.Workbench.getLayoutInflater().inflate(R.layout.pn_qm_device_daily_maintain_check_editor, this, true);
    ...
    public void onPrepared() {
        ...
        if (text_cell_2 != null) {
            text_cell_2.setLabelText("作业周期");
            text_cell_2.setReadOnly();
        }

        if (text_cell_3 != null) {
            text_cell_3.setLabelText("作业内容");
        ...
        if (this.btn_prev != null) {
            ...
            this.btn_prev.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    pn_qm_device_maintain_daily_check_editor.this.prev();
                }
            });
        }
        if (this.btn_next != null) {
            ...
            this.btn_next.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    pn_qm_device_maintain_daily_check_editor.this.next();
                }
            });
        }
    ...
    private void loadItem(long line) {
        ...
        String sql = "exec fm_get_device_maintain_check_item_and ?,?";
        ...
        App.Current.DbPortal.ExecuteRecordAsync("core_and", sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                pn_qm_device_maintain_daily_check_editor.this.ProgressDialog.dismiss();
                ...
                if (value.Value != null) {
                    //检查项目
                    String device_type = value.Value.getValue("device_type", "");
                    String work_rate = value.Value.getValue("work_rate", "");
                    String work_content = value.Value.getValue("work_content", "");
                    ...
                    text_cell_1.setContentText(device_type);
                    text_cell_2.setContentText(work_rate);
                    text_cell_3.setContentText(work_content);
                    button_text_cell_4.setContentText(check_result);
                    text_cell_5.setContentText(reason);
                    if (all_data > 0) {
                        pn_qm_device_maintain_daily_check_editor.this.Header.setTitleText("设备日常保养(" + String.valueOf(all_data) + "条保养任务)");
                    } else {
                        pn_qm_device_maintain_daily_check_editor.this.Header.setTitleText("设备日常保养(无保养任务)");
                    }
                } else {
                    close();
                }
    ...
    private void chooseResult(final ButtonTextCell button_text_cell_4) {
        ...
        new AlertDialog.Builder(pn_qm_device_maintain_daily_check_editor.this.getContext()).setTitle("请选择")
    ...
    public void prev() {
        if (line_id > 2) {
            ...
            App.Current.showError(pn_qm_device_maintain_daily_check_editor.this.getContext(), "已经是第一条。");
        }
    }
    ...
    public void next() {
        if (line_id < counts) {
            ...
            App.Current.showError(pn_qm_device_maintain_daily_check_editor.this.getContext(), "已经是最后一条。");
        }
    }
            ...
            if (TextUtils.isEmpty(button_text_cell_4.getContentText())) {
                ...
                App.Current.question(this.getContext(), "确定要提交吗？", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        String sql = "exec fm_update_device_maintain_check_items_and ?,?,?,?";
