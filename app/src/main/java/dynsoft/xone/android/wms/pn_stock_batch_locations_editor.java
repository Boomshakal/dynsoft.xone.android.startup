...
public class pn_stock_batch_locations_editor extends pn_editor {
	...
	public void commit() 
	{
		String sql = "exec p_mm_stock_batch_update_loc_v1  ?,?,?,?,? ";
	    ...
	    Parameters p= new Parameters().add(1, p_item_no).add(2, p_org_code).add(3, p_lot_number).add(4, p_locs).add(5, App.Current.UserID);
