...
public class pn_tr_entry_mgr extends pn_mgr {

	public pn_tr_entry_mgr(Context context) {
		super(context);
	}
    ...
    public void setContentView()
	{
        ...
        View view = App.Current.Workbench.getLayoutInflater().inflate(R.layout.pn_tr_entry_mgr, this, true);
	...
	public void create()
	{
		...
		if (this.Adapter.DataTable != null && this.Adapter.DataTable.Rows.size() > 0) {
			...
			Link link = new Link("pane://x:code=mm_and_tr_entry_editor");
	        link.Open(this, this.getContext(), null);
		} else {
			App.Current.showInfo(this.getContext(), "没有转入申请。");
		}
	}
    ...
    public View getItemView(int position, View convertView, ViewGroup parent)
    {
        ...
        String item_code = row.getValue("item_code", "");
        ...
        String qty = String.format("转出: %s %s，待转入: %s %s", 
        		App.formatNumber(row.getValue("issue_quantity", BigDecimal.ZERO), "0.##"),
    ...
    public SqlExpression getSqlExpression(int top, int start, int end, String search)
    {
        ...
        expr.SQL = "exec p_mm_tr_entry_get_items ?,?,?,?";
