...
public class pn_smt_steel_car_parameter_out_mgr extends pn_mgr {
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor edit;
    public pn_smt_steel_car_parameter_out_mgr(Context context) {
        super(context);
    }
...
//        txt_line5.setText(row.getValue("items", ""));
    ...
    public void openItem(DataRow row) {
        super.openItem(row);
        Link link = new Link("pane://x:code=pn_smt_roast_editorr");
