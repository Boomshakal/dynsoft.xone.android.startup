...
import dynsoft.xone.android.activity.BomActivity;
...
public class pn_bom_query_mgr extends pn_mgr {
    ...
    public pn_bom_query_mgr(Context context) {
        super(context);
    }
...
//            });
        ...
        btn_commit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getContext(), BomActivity.class);
    ...
    private void loadWorkLineName(final ButtonTextCell text) {
        ...
        multiChoiceDialog(name, selected, names, text);
    ...
    private void multiChoiceDialog(final StringBuffer nameMessage, final boolean[] selected, final ArrayList<String> names, final ButtonTextCell buttonTextCell) {
        new AlertDialog.Builder(pn_bom_query_mgr.this.getContext()).setTitle("请选择")
