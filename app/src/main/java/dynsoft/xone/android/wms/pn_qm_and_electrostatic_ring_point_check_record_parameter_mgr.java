...
public class pn_qm_and_electrostatic_ring_point_check_record_parameter_mgr extends pn_mgr {
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor edit;

    public pn_qm_and_electrostatic_ring_point_check_record_parameter_mgr(Context context) {
        super(context);
    }
