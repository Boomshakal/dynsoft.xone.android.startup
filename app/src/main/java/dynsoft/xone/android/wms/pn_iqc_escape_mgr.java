...
public class pn_iqc_escape_mgr extends pn_mgr {

	public pn_iqc_escape_mgr(Context context) {
		super(context);
	}
    ...
    public void setContentView()
	{
        ...
        View view = App.Current.Workbench.getLayoutInflater().inflate(R.layout.pn_iqc_escape_mgr, this, true);
	...
	public void create()
	{
		Link link = new Link("pane://x:code=mm_and_iqc_escape_editor");
    ...
    public View getItemView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            convertView = App.Current.Workbench.getLayoutInflater().inflate(R.layout.ln_iqc_escape, null);
        ...
        String qty = row.getValue("date_code", "") + ",  " + App.formatNumber(row.getValue("quantity", BigDecimal.ZERO), "0.##") + " " + row.getValue("uom_code", "")+ "£¨" + row.getValue("status", "");
        txt_quantity.setText(qty);
        txt_locations.setText("Ω” ’¥¢Œª£∫" + row.getValue("locations", ""));
    ...
    public SqlExpression getSqlExpression(int top, int start, int end, String search)
    {
        ...
        expr.SQL = "exec p_mm_po_iqc_escape_get_items ?,?,?,?";
