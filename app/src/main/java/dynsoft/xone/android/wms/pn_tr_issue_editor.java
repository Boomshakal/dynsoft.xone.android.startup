...
public class pn_tr_issue_editor extends pn_editor {

    public pn_tr_issue_editor(Context context) {
        super(context);
    }
    ...
    public void onPrepared() {
        ...
        if (this.txt_item_code_cell != null) {
            ...
            this.txt_item_code_cell.Button.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    pn_tr_issue_editor.this.showStockQuantity();
                }
            });
        }
        ...
        if (this.txt_sn_no_cell != null) {
            ...
            this.txt_sn_no_cell.Button.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    String lot_number = pn_tr_issue_editor.this.txt_lot_number_cell.getContentText();
                    String issue_qty = pn_tr_issue_editor.this.txt_issue_quantity_cell.getContentText();
                    pn_tr_issue_editor.this.loadsnno(lot_number, issue_qty);
                }
            });
        }
        ...
        if (this.txt_issue_quantity_cell != null) {
            ...
            this.txt_issue_quantity_cell.TextBox.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    DataRow row = (DataRow) pn_tr_issue_editor.this.txt_onhand_cell.getTag();
                    if (row != null) {
                        ...
                        pn_tr_issue_editor.this.txt_surplus_cell.setContentText(App.formatNumber(surplus, "0.##"));
                    }
                }
            ...
            this.txt_issue_quantity_cell.Button.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    String qty = pn_tr_issue_editor.this.txt_issue_quantity_cell.getContentText();
                    pn_tr_issue_editor.this.printLabel(qty);
                }
            });
        }
        ...
        if (this.txt_surplus_cell != null) {
            ...
            this.txt_surplus_cell.Button.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    String qty = pn_tr_issue_editor.this.txt_surplus_cell.getContentText();
                    pn_tr_issue_editor.this.printLabel(qty);
                }
            });
        }
        ...
        if (this.btn_print != null) {
            ...
            this.btn_print.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    pn_tr_issue_editor.this.print_status();
                }
            });
        }
        ...
        if (_line_id > 0) {
            ...
            if (r.HasError) {
                App.Current.showError(pn_tr_issue_editor.this.getContext(), "没有指定转移申请编号。");
                this.close();
            }
    ...
    public void prev() {
        if (_rownum > 1) {
            ...
            App.Current.showError(pn_tr_issue_editor.this.getContext(), "已经是第一条。");
        }
    }
    ...
    public void next() {
        if (_rownum < _total) {
            ...
            App.Current.showError(pn_tr_issue_editor.this.getContext(), "已经是最后一条。");
        }
    }
    ...
    public void loadsnno(String lot_number, String issue_qty) {
        ...
        String sql = "exec p_mm_tr_issue_get_prod_sn_no ?,?";
        Parameters p = new Parameters().add(1, lot_number).add(2, issue_qty);
        App.Current.DbPortal.ExecuteRecordAsync(this.Connector, sql, p, new ResultHandler<DataRow>() {
            @Override
            public void handleMessage(Message msg) {

                pn_tr_issue_editor.this.ProgressDialog.dismiss();

                Result<DataRow> r = this.Value;
                if (r.HasError) {
                    App.Current.showError(pn_tr_issue_editor.this.getContext(), r.Error);
                    return;
                }
                ;
                ...
                if (result.length() > 0) {
                    App.Current.showError(pn_tr_issue_editor.this.getContext(), result);
                    return;
                }
                ...
                if (pack_sn_no != null && pack_sn_no.length() != 0) {
                    pn_tr_issue_editor.this.txt_sn_no_cell.setContentText(pack_sn_no);
                }
            }
        });
    ...
    public void loadTaskOrderItem(long index) {
        ...
        if (code == null || code.length() == 0) {
            App.Current.showError(pn_tr_issue_editor.this.getContext(), "没有指定转出申请编号。");
            return;
        }
        ...
        App.Current.DbPortal.ExecuteRecordAsync(this.Connector, sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (result.HasError) {
                    App.Current.showError(pn_tr_issue_editor.this.getContext(), result.Error);
                    return;
                }

                _order_row = result.Value;
                if (_order_row == null) {
                    App.Current.showError(pn_tr_issue_editor.this.getContext(), "没有数据。");
                    pn_tr_issue_editor.this.clearAll();
                    pn_tr_issue_editor.this.Header.setTitleText("库存转移");
                    return;
                }
                ...
                if (_total > 0) {
                    pn_tr_issue_editor.this.Header.setTitleText("库存转移(共" + String.valueOf(_total) + "条)");
                } else {
                    pn_tr_issue_editor.this.Header.setTitleText("库存转移");
                }
                ...
                pn_tr_issue_editor.this.txt_tr_order_cell.setContentText(order_code);
                pn_tr_issue_editor.this.txt_item_code_cell.setContentText(item_code);
                pn_tr_issue_editor.this.txt_item_name_cell.setContentText(_order_row.getValue("item_name", ""));
                pn_tr_issue_editor.this.txt_vendor_name_cell.setContentText(_order_row.getValue("vendor_name", ""));
                pn_tr_issue_editor.this.txt_date_code_cell.setContentText(_order_row.getValue("date_code", ""));
                ...
                pn_tr_issue_editor.this.txt_quantity_cell.setContentText(qty_str);
                pn_tr_issue_editor.this.txt_location_cell.setContentText(_order_row.getValue("locations", ""));

                pn_tr_issue_editor.this.txt_lot_number_cell.setTag(null);
                pn_tr_issue_editor.this.txt_lot_number_cell.setContentText("");
                pn_tr_issue_editor.this.txt_issue_quantity_cell.setContentText("");
                pn_tr_issue_editor.this.txt_onhand_cell.setContentText("");
                pn_tr_issue_editor.this.txt_onhand_cell.setTag(null);
                pn_tr_issue_editor.this.txt_surplus_cell.setContentText("");
                pn_tr_issue_editor.this.txt_location_cell.setContentText(_order_row.getValue("locations", ""));
            }
        });
    }
        ...
        App.Current.DbPortal.ExecuteRecordAsync(this.Connector, sql, p, new ResultHandler<DataRow>() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (r.Value != null) {
                    ...
                    App.Current.showInfo(pn_tr_issue_editor.this.getContext(), str);
                }
            }
        });
    }
    ...
    public void loadLotNumber(String lotNumber) {
        if (_order_row == null) {
            App.Current.toastError(pn_tr_issue_editor.this.getContext(), "缺少转移申请数据");
            return;
        }
            ...
            public void handleMessage(Message msg) {
                ...
                if (result.length() > 0) {
                    if (result.indexOf("温馨提示：") == -1) {
                        ...
                        App.Current.question(pn_tr_issue_editor.this.getContext(), result, new DialogInterface.OnClickListener() {
                            @Override
    ...
    public void loaditem() {
        ...
        pn_tr_issue_editor.this.txt_vendor_name_cell.setContentText(_lot_row.getValue("vendor_name", ""));
        pn_tr_issue_editor.this.txt_vendor_name_cell.setTag(_lot_row.getValue("vendor_id"));
        pn_tr_issue_editor.this.txt_lot_number_cell.setTag(_lot_row);
        pn_tr_issue_editor.this.txt_lot_number_cell.setContentText(_lot_row.getValue("lot_number", ""));
        pn_tr_issue_editor.this.txt_date_code_cell.setContentText(_lot_row.getValue("date_code", ""));
        pn_tr_issue_editor.this.txt_location_cell.setContentText(_lot_row.getValue("locations", ""));
        pn_tr_issue_editor.this.txt_onhand_cell.setTag(_lot_row);
        pn_tr_issue_editor.this.txt_onhand_cell.setContentText(App.formatNumber(onhand_quantity, "0.##"));
        pn_tr_issue_editor.this.txt_issue_quantity_cell.setContentText(App.formatNumber(issue_quantity, "0.##"));
    }
                        ...
                        if (i == 1) {
                            ...
                            App.Current.DbPortal.ExecuteRecordAsync("core_and", sql, new ResultHandler<DataRow>() {
                                ...
                                public void handleMessage(Message msg) {
                                    ...
                                    if (value.HasError) {
                                        App.Current.toastError(pn_tr_issue_editor.this.getContext(), value.Error);
                                        return;
                                    }
                                    if (value.Value != null) {
    ...
    public void commit() {
        ...
        final String locations = pn_tr_issue_editor.this.txt_location_cell.getContentText();
        final Integer vendor_id = lot_row.getValue("vendor_id", Integer.class);
        final String date_code = lot_row.getValue("date_code", "");
        final String snnos = pn_tr_issue_editor.this.txt_sn_no_cell.getContentText();
        ...
        App.Current.question(this.getContext(), "确定要提交吗？", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Connection conn = App.Current.DbPortal.CreateConnection(pn_tr_issue_editor.this.Connector);
                ...
                try {
                    ...
                    if (val != null) {
                        ...
                        if (rs.HasError) {
                            App.Current.showError(pn_tr_issue_editor.this.getContext(), rs.Error);
                            return;
                        }

                        _order_row = null;
                        App.Current.toastInfo(pn_tr_issue_editor.this.getContext(), "提交成功");
                    ...
                    _order_row = null;
                    App.Current.showInfo(pn_tr_issue_editor.this.getContext(), e.getMessage());
                    e.printStackTrace();
